    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form action="/agama10/{{$data['id']}}" method="post" id="inputForm" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <input type="hidden" name="id" id="id" value="{{$data['id']}}" />
                        <div class="form-group">
                            <label for="name">Agama</label>
                            <input type="text" id="name" name="namaagama" class="form-control" placeholder="Nama Agama" value="{{old('namaagama', $data['namaagama'])}}" required>
                            @error('namagama')
